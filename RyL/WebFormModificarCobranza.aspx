<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebFormModificarCobranza.aspx.cs" Inherits="RyL.WebFormModificarCobranza" %>
                    ...
                    <form id="form1" runat="server">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <asp:TextBox ID="TextBoxTotal" class="form-control" runat="server" TextMode="Number" required></asp:TextBox>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col">
                                <label for="TextBoxComentario" class="form-label">Comentario:</label>
                                <asp:TextBox ID="TextBoxComentario" class="form-control" runat="server" TextMode="MultiLine" required></asp:TextBox>
                            </div>
                        </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebFormListarCobranza.aspx.cs" Inherits="RyL.WebFormListarCobranza" %>
                    ...
                    <table class="table table-hover table-bordered table-secondary table-striped shadow-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><%=cobro.Folio%></td>
                                <td><%=Convert.ToDateTime(cobro.FechaIngreso).Date.ToString("dd-MM-yyyy")%></td>
                                <td><%=string.Format("{0:C0}", cobro.Total)%></td>
                                <td><%=cobro.Comentario%></td>
                                <td>
                                    <a class="btn btn-primary" href="WebFormModificarCobranza.aspx?id=<%=cobro.Folio%>" />Modificar
                                </td>
                                <td>
                                    <a class="btn btn-primary" href="WebFormVerCobranza.aspx?id=<%=cobro.Folio%>" />Visualizar
                                </td>
                            </tr>
                            <%
                                }

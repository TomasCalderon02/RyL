<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebFormVerVenta.aspx.cs" Inherits="RyL.WebFormVerVENTA" %>
                    ...
                    <form id="form1" runat="server">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <asp:DropDownList ID="DropDownListDoc" runat="server" class="form-select" aria-label="Default select example" disabled>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <asp:TextBox ID="TextBoxRutCliente" class="form-control" runat="server" ReadOnly></asp:TextBox>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col">
                                <label for="TextBoxRazonSocial" class="form-label">Razon Social:</label>
                                <asp:TextBox ID="TextBoxRazonSocial" class="form-control" runat="server" ReadOnly></asp:TextBox>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col">
                                <label for="TextBoxFolio" class="form-label">Folio:</label>
                                <asp:TextBox ID="TextBoxFolio" class="form-control" runat="server" ReadOnly></asp:TextBox>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col">
                                <label for="TextBoxFechaDocto" class="form-label">Fecha Docto:</label>
                                <asp:TextBox ID="TextBoxFechaDocto" class="form-control" runat="server" TextMode="Date" ReadOnly></asp:TextBox>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col">
                                <label for="TextBoxMontoTotal" class="form-label">Monto Total:</label>
                                <asp:TextBox ID="TextBoxMontoTotal" class="form-control" runat="server" ReadOnly></asp:TextBox>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col">
                                <label for="TextBoxFechaPago" class="form-label">Fecha de Pago:</label>
                                <asp:TextBox ID="TextBoxFechaPago" class="form-control" runat="server" TextMode="Date" ReadOnly></asp:TextBox>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col">
                                <label for="TextBoxVendedor" class="form-label">Vendedor:</label>
                                <asp:TextBox ID="TextBoxVendedor" class="form-control" runat="server" ReadOnly></asp:TextBox>
                            </div>
                        </div>
                    </form>
                </div>

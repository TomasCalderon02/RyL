<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebFormListarVentas.aspx.cs" Inherits="RyL.WebFormListarVentas" %>
                    ...
                    <table class="table table-hover  table-bordered table-secondary table-striped shadow-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><%=v.RazonSocial%></td>
                                <td><%=v.Folio%></td>
                                <td><%=Convert.ToDateTime(v.FechaDocto).Date.ToString("dd-MM-yyyy")%></td>
                                <td><%=string.Format("{0:C0}", v.MontoTotal)%></td>
                                <td><%=Convert.ToDateTime(v.FechaPago).Date.ToString("dd-MM-yyyy")%></td>
                                <td><%=v.Vendedor%></td>
                                <td>
                                    <a class="btn btn-primary" href="WebFormModificarVenta.aspx?id=<%=v.Id%>" />Modificar
                                </td>
                                <td>
                                    <a class="btn btn-primary" href="WebFormVerVenta.aspx?id=<%=v.Id%>" />Visualizar
                                </td>

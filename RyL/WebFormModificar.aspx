<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebFormModificar.aspx.cs" Inherits="RyL.WebFormModificar" %>
                    ...
                    <form id="form1" runat="server">
                        ...
                        <fieldset>
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    <label for="TextBoxEMP" class="form-label">ID Empleado:</label>
                                    <asp:TextBox ID="TextBoxEMP" class="form-control" runat="server" TextMode="Number" required ReadOnly></asp:TextBox>
                                    <label for="TextBoxAD" class="form-label">ID Admin:</label>
                                    <asp:TextBox ID="TextBoxAD" class="form-control" runat="server" TextMode="Number" required ReadOnly></asp:TextBox>
                        ...
                        <fieldset>
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <asp:FileUpload ID="FileUploadMontaje" class="form-control" runat="server" />
                                    <label for="TextBoxMontaje" class="form-label">Foto Actual:</label>
                                    <asp:TextBox ID="TextBoxMontaje" class="form-control" runat="server" ReadOnly></asp:TextBox>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                        ...
                        <div class="row">
                            <div class="d-grid gap-2">
                                <asp:Button ID="ButtonModificar" class="btn btn-primary" runat="server" OnClick="ButtonModificar_Click" Text="Modificar" />
                            </div>
                        </div>
                    </form>
                </div>

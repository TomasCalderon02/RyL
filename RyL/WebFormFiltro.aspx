<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebFormFiltro.aspx.cs" Inherits="RyL.WebFormFiltro" %>

<%@ Import Namespace="RyL" %>
            ...
            <main>
                <div class="cajaForm">
                    <form id="form1" runat="server">
                        <label for="RadioButtonListCampo">Filtrar registros por:</label>
                        <div class="row">
                            <div class="col">
                                <asp:RadioButtonList ID="RadioButtonListCampo" runat="server">
                                    <asp:ListItem Value="Rut_cliente" Selected="True">RUT del Cliente</asp:ListItem>
                                    <asp:ListItem Value="Trabajo">Trabajo</asp:ListItem>
                                </asp:RadioButtonList>
                            </div>
                            <div class="col">
                                <asp:TextBox ID="TextBoxFiltro" class="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <asp:Button ID="Button" class="form-control btn btn-primary" runat="server" OnClick="Button_Click" Text="Filtrar" />
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="container table-responsive">
                    <table class="table table-hover table-bordered table-secondary table-striped shadow-sm">
                        <thead>
                            <tr>
                                <th scope="col">ID</th>
                        ...
                        <tbody>
                            <%foreach (ordenTrabajo ot in ordenTrabajoDAO.Filtro(RadioButtonListCampo.SelectedValue, TextBoxFiltro.Text))
                                {
                            %>
                            <tr>
                                ...
                                <td><%=ot.Trabajo%></td>
                                <td>
                                    <a class="btn btn-primary" href="WebFormModificar.aspx?id=<%=ot.Id%>" />Modificar
                                </td>
                                <td>
                                    <a class="btn btn-primary" href="WebFormVer.aspx?id=<%=ot.Id%>" />Visualizar
                                </td>
